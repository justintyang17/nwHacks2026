...
export const useEditedVideoContext = () => {
    ...
    if (!context) throw new Error("useEditedVideoContext must be used within EditedVideoProvider");
    return context;
};